...
Prepare a short presentation (max ~7 slides, any format) covering:
...
5. What you'd do next with more time.

You'll present this at the start of your interview, followed by a Q&A where we'll dig into your choices.

---

## What to submit

At least 24 hours before your interview, send us:

- A link to (or export of) your Databricks notebook(s) — `.dbc`, `.ipynb`, or a shared link.
- Your presentation file.
- Anything else you produced (data quality log, SQL, etc.) if not already in the notebooks.
